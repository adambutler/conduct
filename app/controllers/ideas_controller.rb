class IdeasController < ApplicationController
  ...
  def create
    ...
    @idea.topic_id = @topic.to_param
    
    respond_to do |format|
      if @idea.save
        format.html { redirect_to @topic, notice: 'Idea was successfully created.' }
        format.json { render action: 'show', status: :created, location: [@topic, @idea] }
      else
  ...
  private
    ...
    def idea_params
      params.require(:idea).permit(:title, :description, :topic_id, :user_id)
    end
end
